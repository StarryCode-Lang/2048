...
const zh = {
  ...
  aiSpeed: "AI 运行速度", aiEngine: "AI 引擎", engineSearch: "搜索引擎", engineExpert: "专家实验", pause: "暂停", start: "开始", routeLabel: "AI 采用左上角保角蛇形路线",
  ...
  restart: "重新开始", closeHelp: "关闭玩法说明", helpKicker: "玩法说明", howTo: "怎么玩", fair: "公平", understood: "知道了",
  ...
  language: "语言", chooseLanguage: "选择界面语言", chooseSpeed: "选择 AI 运行速度", importReplay: "导入回放", importReplayHint: "导入并验证完整对局日志", importedReplay: "回放已验证并载入", importFailed: "回放无效或已损坏", exportCurrentHint: "导出当前完整对局日志",
...
const en: Translation = {
  ...
  aiSpeed: "AI speed", aiEngine: "AI engine", engineSearch: "Search", engineExpert: "Expert lab", pause: "Pause", start: "Start", routeLabel: "AI top-left anchored snake route",
  ...
  restart: "Restart", closeHelp: "Close instructions", helpKicker: "HOW TO PLAY", howTo: "How to play", fair: "Fair", understood: "Got it",
  ...
  language: "Language", chooseLanguage: "Choose interface language", chooseSpeed: "Choose AI speed", importReplay: "Import replay", importReplayHint: "Import and verify a complete game log", importedReplay: "Replay verified and loaded", importFailed: "Replay is invalid or corrupted", exportCurrentHint: "Export the complete current-game log",
...
const fr: Translation = {
  ...
  aiSpeed: "Vitesse de l’IA", aiEngine: "Moteur IA", engineSearch: "Recherche", engineExpert: "Expert expérimental", pause: "Pause", start: "Démarrer", routeLabel: "Parcours en serpentin ancré en haut à gauche", anchor: "Ancrage en haut à gauche", endgame: "Finale approfondie",
  ...
  continueRound: "Continuer", switchMode: "Changer de mode", restart: "Recommencer", closeHelp: "Fermer les règles", helpKicker: "RÈGLES DU JEU", howTo: "Comment jouer", fair: "Équité", understood: "Compris",
  ...
  importReplay: "Importer une partie", importReplayHint: "Importer et vérifier un journal complet", importedReplay: "Partie vérifiée et chargée", importFailed: "Partie invalide ou corrompue", exportRecordHint: "Exporter le journal du record", exportedCurrent: "Journal de la partie exporté", exportedRecord: "Journal du record exporté", exportFailed: "Échec de l’exportation. Réessayez.",
...
const es: Translation = {
  ...
  aiSpeed: "Velocidad de IA", aiEngine: "Motor de IA", engineSearch: "Búsqueda", engineExpert: "Experto experimental", pause: "Pausar", start: "Iniciar", routeLabel: "Ruta serpenteante anclada arriba a la izquierda", anchor: "Anclaje superior izquierdo", endgame: "Final profundo",
  ...
  continueRound: "Seguir jugando", switchMode: "Cambiar modo", restart: "Reiniciar", closeHelp: "Cerrar instrucciones", helpKicker: "CÓMO JUGAR", howTo: "Cómo jugar", fair: "Justo", understood: "Entendido",
  ...
  importReplay: "Importar partida", importReplayHint: "Importar y verificar un registro completo", importedReplay: "Partida verificada y cargada", importFailed: "Partida inválida o dañada", exportRecordHint: "Exportar el registro del récord", exportedCurrent: "Registro de la partida exportado", exportedRecord: "Registro del récord exportado", exportFailed: "Error al exportar. Inténtalo de nuevo.",
...
const ru: Translation = {
  ...
  aiSpeed: "Скорость ИИ", aiEngine: "Движок ИИ", engineSearch: "Поиск", engineExpert: "Экспериментальный эксперт", pause: "Пауза", start: "Старт", routeLabel: "Змейка с якорем в левом верхнем углу", anchor: "Якорь слева сверху", endgame: "Глубокий эндшпиль",
  ...
  continueRound: "Продолжить", switchMode: "Сменить режим", restart: "Начать заново", closeHelp: "Закрыть правила", helpKicker: "КАК ИГРАТЬ", howTo: "Как играть", fair: "Честно", understood: "Понятно",
  ...
  importReplay: "Импорт игры", importReplayHint: "Импортировать и проверить полный журнал", importedReplay: "Игра проверена и загружена", importFailed: "Журнал игры повреждён или недействителен", exportRecordHint: "Экспортировать журнал рекорда", exportedCurrent: "Журнал игры экспортирован", exportedRecord: "Журнал рекорда экспортирован", exportFailed: "Не удалось экспортировать. Повторите попытку.",
...
const ar: Translation = {
  ...
  aiSpeed: "سرعة الذكاء الاصطناعي", aiEngine: "محرك الذكاء الاصطناعي", engineSearch: "بحث", engineExpert: "خبير تجريبي", pause: "إيقاف مؤقت", start: "ابدأ", routeLabel: "مسار متعرج مثبت في أعلى اليسار", anchor: "تثبيت أعلى اليسار", endgame: "حساب عميق للنهاية",
  ...
  continueRound: "متابعة الجولة", switchMode: "تبديل الوضع", restart: "إعادة البدء", closeHelp: "إغلاق التعليمات", helpKicker: "طريقة اللعب", howTo: "طريقة اللعب", fair: "عادل", understood: "فهمت",
  ...
  importReplay: "استيراد الإعادة", importReplayHint: "استيراد سجل الجولة الكامل والتحقق منه", importedReplay: "تم التحقق من الإعادة وتحميلها", importFailed: "الإعادة غير صالحة أو تالفة", exportRecordHint: "تصدير سجل أعلى نتيجة", exportedCurrent: "تم تصدير سجل الجولة", exportedRecord: "تم تصدير سجل أعلى نتيجة", exportFailed: "تعذر التصدير. حاول مرة أخرى.",
