...
const zh = {
  ...
  aiSpeed: "AI 运行速度", aiEngine: "AI 引擎", engineSearch: "搜索引擎", engineExpert: "自适应专家", pause: "暂停", start: "开始", routeLabel: "AI 采用左上角保角蛇形路线",
...
const en: Translation = {
  ...
  aiSpeed: "AI speed", aiEngine: "AI engine", engineSearch: "Search", engineExpert: "Adaptive Expert", pause: "Pause", start: "Start", routeLabel: "AI top-left anchored snake route",
...
const fr: Translation = {
  ...
  aiSpeed: "Vitesse de l’IA", aiEngine: "Moteur IA", engineSearch: "Recherche", engineExpert: "Expert adaptatif", pause: "Pause", start: "Démarrer", routeLabel: "Parcours en serpentin ancré en haut à gauche", anchor: "Ancrage en haut à gauche", endgame: "Finale approfondie",
...
const es: Translation = {
  ...
  aiSpeed: "Velocidad de IA", aiEngine: "Motor de IA", engineSearch: "Búsqueda", engineExpert: "Experto adaptativo", pause: "Pausar", start: "Iniciar", routeLabel: "Ruta serpenteante anclada arriba a la izquierda", anchor: "Anclaje superior izquierdo", endgame: "Final profundo",
...
const ru: Translation = {
  ...
  aiSpeed: "Скорость ИИ", aiEngine: "Движок ИИ", engineSearch: "Поиск", engineExpert: "Адаптивный эксперт", pause: "Пауза", start: "Старт", routeLabel: "Змейка с якорем в левом верхнем углу", anchor: "Якорь слева сверху", endgame: "Глубокий эндшпиль",
...
const ar: Translation = {
  ...
  aiSpeed: "سرعة الذكاء الاصطناعي", aiEngine: "محرك الذكاء الاصطناعي", engineSearch: "بحث", engineExpert: "خبير تكيفي", pause: "إيقاف مؤقت", start: "ابدأ", routeLabel: "مسار متعرج مثبت في أعلى اليسار", anchor: "تثبيت أعلى اليسار", endgame: "حساب عميق للنهاية",
