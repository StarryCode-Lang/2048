...
- AI 自动挑战，4×4 使用高吞吐位棋盘 Expectimax，支持极速、100ms、500ms 三档速度；可切换前期 afterstate、拥挤局面 Search 的自适应专家引擎
- AI 挑战全程禁止撤回，不预知下一随机块
- 当前局和历史最高分完整日志导出，也可导入并验证完整回放；v4 日志逐步记录 AI 引擎来源
